  ...
  <div class="container">
      ...
      ?>
        <div class="card card-container">
            ...
            ?>
            <form class="form-signin" action="includes/admin_login.inc.php" method="post">
                <span id="reauth-email" class="reauth-email"></span>
                <input name="email" type="text" id="inputEmail" class="form-control" placeholder="Admin email" autofocus>
                <input name="pass" type="password" id="inputPassword" class="form-control" placeholder="Admin password" >
